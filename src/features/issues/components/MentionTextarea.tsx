...
import { formatMention, getActiveMention } from "@/shared/utils/youtrackMentions";
...
export function MentionTextarea({
  ...
  const filteredUsers = useMemo(() => {
    ...
    return users
      .filter((user) => {
        const handle = user.mentionHandle.toLowerCase();
  ...
  const selectUser = useCallback(
    (user: MentionableUser) => {
      ...
      const mention = formatMention(user.mentionHandle);
