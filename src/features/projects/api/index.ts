...
import type { ApiPaginatedResult, CreateProjectDto, PaginatedResult, Project, ProjectListParams, UpdateProjectDto } from "../types";
...
export const projectsApi = {
  ...
  create: (data: CreateProjectDto) => apiRequest<Project>({ method: "POST", url: "/projects", data }),
  update: (id: string, data: UpdateProjectDto) => apiRequest<Project>({ method: "PUT", url: `/projects/${id}`, data }),
