    ...
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        ...
        className={cn(
          ...
          "min-w-32 origin-(--radix-context-menu-content-transform-origin)",
...
function ContextMenuLabel({
  ...
  return <ContextMenuPrimitive.Label data-slot="context-menu-label" data-inset={inset} className={cn("text-foreground px-2 py-1.5 text-sm font-semibold", inset && "pl-8", className)} {...props} />;
}
